...
%     image_imag = double(buf_imag);
    ...
    figure()
    mesh(image_real);
    title(['2B 400kHz ' num2str(2^var*100) 'µm Realpart']);
    
    figure()
    mesh(image_imag);
    title(['2B 400kHz ' num2str(2^var*100) 'µm Imagpart']);
    
    figure()
    mesh(abs(image_complex));
    title(['2B 400kHz ' num2str(2^var*100) 'µm Module']);
    
    figure()
    mesh(angle(image_complex));
    title(['2B 400kHz ' num2str(2^var*100) 'µm Phase']);
end
...
%     image_sub =  image_ground - image_corr;
    ...
    figure()
    mesh(image_sub);
    title(['2B 400kHz ' num2str(2^var*100) 'µm -- Subtracted Module']);
...
%     plot(image_complex,'b-'), axis('equal')
    ...
    limit = 12*mean(std(noise_mat));    %14 ////////////////////////////
...
%     end
    ...
    figure()
    mesh(length_finding)
    title(['2B 400kHz ' num2str(2^var*100) 'µm -- Length Finding']);
    ...
    disp(['2B 400kHz ' num2str(2^var*100) 'µm'])
...
%     plot(image_complex,'b-'), axis('equal')
    ...
    limit1 = 12*mean(std(noise_mat));   %14 ////////////////////////////
