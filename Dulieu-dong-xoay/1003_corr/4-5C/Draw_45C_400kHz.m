for var = 1:3
    image_real = double(imread(['45C_400kHz_' num2str(2^var*100) 'u_realpart.tif']));
    image_imag = double(imread(['45C_400kHz_' num2str(2^var*100) 'u_imagpart.tif']));
...
%     image_imag = double(buf_imag);
    ...
    figure()
    mesh(image_real);
    title(['45C 400kHz ' num2str(2^var*100) 'µm Realpart']);
    
    figure()
    mesh(image_imag);
    title(['45C 400kHz ' num2str(2^var*100) 'µm Imagpart']);
    
    figure()
    mesh(abs(image_complex));
    title(['45C 400kHz ' num2str(2^var*100) 'µm Module']);
    
    figure()
    mesh(angle(image_complex));
    title(['45C 400kHz ' num2str(2^var*100) 'µm Phase']);
end
...
%     image_sub =  image_ground - image_corr;
    ...
    figure()
    mesh(image_sub);
    title(['45C 400kHz ' num2str(2^var*100) 'µm -- Subtracted Module']);
...
%     end
    ...
    figure()
    mesh(length_finding)
    title(['45C 400kHz ' num2str(2^var*100) 'µm -- Length Finding']);
    ...
    disp(['45C 400kHz ' num2str(2^var*100) 'µm'])
