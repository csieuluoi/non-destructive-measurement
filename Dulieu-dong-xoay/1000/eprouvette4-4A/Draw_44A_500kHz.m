...
%     image_imag = double(buf_imag);
    ...
    figure()
    mesh(image_real);
    title(['44A 500kHz ' num2str(2^var*100) 'µm Realpart']);
    
    figure()
    mesh(image_imag);
    title(['44A 500kHz ' num2str(2^var*100) 'µm Imagpart']);
    ...
    title(['44A 500kHz ' num2str(2^var*100) 'µm Phase']);
end
...
% Ma tran anh bo nen:
    ...
    figure()
    mesh(image_sub);
    title(['44A 500kHz ' num2str(2^var*100) 'µm -- Subtracted Module']);
...
%     end
    ...
    figure()
    mesh(length_finding)
    title(['44A 500kHz ' num2str(2^var*100) 'µm -- Length Finding']);
