...
%     image_imag = double(buf_imag);
    ...
    figure()
    mesh(image_real);
    title(['45A 500kHz ' num2str(2^var*100) 'µm Realpart']);
    
    figure()
    mesh(image_imag);
    title(['45A 500kHz ' num2str(2^var*100) 'µm Imagpart']);
    ...
    title(['45A 500kHz ' num2str(2^var*100) 'µm Phase']);
end
...
% Ma tran anh bo nen:
    ...
    figure()
    mesh(image_sub);
    title(['45A 500kHz ' num2str(2^var*100) 'µm -- Subtracted Module']);
...
%     plot(image_complex,'b-'), axis('equal')
    ...
    limit = 12*mean(std(noise_mat)); %12 ///////////////////////////////
...
%     end
    ...
    figure()
    mesh(length_finding)
    title(['45A 500kHz ' num2str(2^var*100) 'µm -- Length Finding']);
...
%     plot(image_complex,'b-'), axis('equal')
    ...
    limit1 = 12*mean(std(noise_mat));    %12 //////////////////////////////
