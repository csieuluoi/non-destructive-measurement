...
%     image_imag = double(imread(bur_imag));
    ...
    figure()
    mesh(image_real);
    title(['2A 500kHz ' num2str(2^var*100) 'µm Realpart']);
    
    figure()
    mesh(image_imag);
    title(['2A 500kHz ' num2str(2^var*100) 'µm Imagpart']);
    
    figure()
    mesh(abs(image_complex));
    title(['2A 500kHz ' num2str(2^var*100) 'µm Module']);
    
    figure()
    mesh(angle(image_complex));
    title(['2A 500kHz ' num2str(2^var*100) 'µm Phase']);
end
...
%     end
    ...
    figure()
    mesh(length_finding)
    title(['2A 500kHz ' num2str(2^var*100) 'µm -- Length Finding']);
    ...
    disp(['2A 500kHz ' num2str(2^var*100) 'µm'])
