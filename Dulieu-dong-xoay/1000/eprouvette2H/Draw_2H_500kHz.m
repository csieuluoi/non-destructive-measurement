...
%     image_imag = double(buf_imag);
    ...
    figure()
    mesh(image_real);
    title(['2H 500kHz ' num2str(2^var*100) 'µm Realpart']);
    
    figure()
    mesh(image_imag);
    title(['2H 500kHz ' num2str(2^var*100) 'µm Imagpart']);
    ...
    title(['2H 500kHz ' num2str(2^var*100) 'µm Phase']);
end
...
% Ma tran anh bo nen:
    ...
    figure()
    mesh(image_sub);
    title(['2H 500kHz ' num2str(2^var*100) 'µm -- Subtracted Module']);
...
%     plot(image_complex,'b-'), axis('equal')
    ...
    limit = 10*mean(std(noise_mat)); %10 ///////////////////////////////
...
%     end
    ...
    figure()
    mesh(length_finding)
    title(['2H 500kHz ' num2str(2^var*100) 'µm -- Length Finding']);
...
%     plot(image_complex,'b-'), axis('equal')
    ...
    limit1 = 10*mean(std(noise_mat));    %10 //////////////////////////////
