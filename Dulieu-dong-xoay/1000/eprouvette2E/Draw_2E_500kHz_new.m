for var = 1:3
    buf_real = imread(['2E_500kHz_' num2str(2^var*100) 'u_realpart.tif']);
    buf_imag = imread(['2E_500kHz_' num2str(2^var*100) 'u_imagpart.tif']);
...
title('2E 1000 -- Module max & Depth --');

figure()
plot(depth,AVE_angle_vec,'ro-','LineWidth',2)
title('2E 1000 -- Angle max & Depth --');