...
%     image_imag = double(buf_imag);
    ...
    figure()
    mesh(image_real);
    title(['2Ee 5MHz 1002 ' num2str(2^var*100) 'µm Realpart']);
    
    figure()
    mesh(image_imag);
    title(['2Ee 5MHz 1002 ' num2str(2^var*100) 'µm Imagpart']);
    
    figure()
    mesh(abs(image_complex));
    title(['2Ee 5MHz 1002 ' num2str(2^var*100) 'µm Module']);
    
    figure()
    mesh(angle(image_complex));
    title(['2Ee 5MHz 1002 ' num2str(2^var*100) 'µm Phase']);
end